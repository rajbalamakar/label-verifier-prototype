...
function HistoryStatusIcon({ status }) {
  const color = status?.startsWith('mismatch') ? '#e65100' : status === 'pass' ? '#2d7a3a' : status === 'fail' ? '#c0392b' : status === 'review' ? '#e67e22' : '#aaa'
  ...
  if (status === 'review') return <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }}><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>
...
function HistoryBadge({ status }) {
  ...
  if (status === 'review') return <span style={badge('#fff3cd', '#856404')}>REVIEW</span>
